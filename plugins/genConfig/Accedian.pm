...
sub custom_targets {
    ...
    foreach my $key ( sort keys %acdPaaKeyName ) {
      ...
      my $Peer      = $acdPaaKeyPeer{$key};
        ...
        my ($ldesc) = "Metronid: $servicename Mtu: $Mtu Peer: $Peer <BR>Values in microseconds. 1000us = 1ms<BR>Alerte lorsque le delais est plus que 50000us ou de la perte de paquet.";
